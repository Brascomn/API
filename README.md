...
Acrônimo de Application Programming Interface  é  um conjunto de rotinas e padrões estabelecidos por uma aplicação, para que outras aplicações possam utilizar as funcionalidades desta aplicação.
...
RESTful, é a aplicação ou cumprimento dos padrões REST.
